...
import com.example.demosetupproject.responseFile.ResponseFile;
import com.example.demosetupproject.responseFile.ResponseMessage;
import com.example.demosetupproject.service.PictureService;
    ...
    public ResponseEntity<byte[]> getPicture(@PathVariable("id")Long id) {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION,
                        "attachement; filename =\"" + picture.getName() + "\"")
